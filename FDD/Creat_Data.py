...
class Normal_DataSet():
    ...
    def Creat_DataSet(self):
        ...
        Fault_index=[val for val in Fault_index for i in range(200)]
    ...
    def __Creat_NormalDataSet__(self):
        ...
        # ##  nonlinear ##########
        # t1 = np.random.rand(self.sample_num_train+self.sample_num_test, 1)**0.5
        # t2 = np.random.rand(self.sample_num_train+self.sample_num_test, 1)*0.8**(-2)
        # t3 = np.random.rand(self.sample_num_train+self.sample_num_test, 1)*0.6**(-1)
